...
cr.val1=5.258819
po11=power.cov.norm1(4,2,3,3,s_A=4,s_B=4,critic.val=cr.val1)
po12=power.cov.norm1(6,2,3,3,s_A=4,s_B=4,critic.val=cr.val1)
po13=power.cov.norm1(8,2,3,3,s_A=4,s_B=4,critic.val=cr.val1)
plot(c(0,2,4,6),c(0.0396,p11,p12,p13),type="l",lty=1,xlab="Diferences of alpha",ylab="Power",main="Power Curve",lwd=2,ylim=c(0,1))
p00=0.0396
p11=0.0496
p12=0.1304
p13=0.8606
...
po21=power.cov.norm2(4,2,3,3,s_A=4,s_B=4,critic.val=cr.val2)
po22=power.cov.norm2(6,2,3,3,s_A=4,s_B=4,critic.val=cr.val2)
po23=power.cov.norm2(8,2,3,3,s_A=4,s_B=4,critic.val=cr.val2)
cr.val2=1.553204
p20=0.08
p21=0.3552
p22=0.5946
...
legend("topright",legend=c("Max stat","Average stat"),lty=c(1,2),lwd=2)
