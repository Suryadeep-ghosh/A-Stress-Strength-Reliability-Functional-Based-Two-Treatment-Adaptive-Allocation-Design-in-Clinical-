...
{
  set.seed(100)
  po[i]=power1.norm(100,mA[i],5,sA[i],2,cr.val)
}
plot(mA-5,po,type="l",col="red",xlab="difference in mu & sigma",ylab="Power",main="Power Curves",lwd=2)
...
{
  set.seed(100)
  po2[i]=power4.norm(100,mA[i],5,sA[i],2,cr.val.Q)
}
lines(mA-5,po2,col="blue",lwd=2)
...
{
  set.seed(100)
  po3[i]=power3.norm(100,mA[i],5,sA[i],2,cr.val.A)
}
lines(mA-5,po3,col="orange",lwd=2)
legend("bottomright",legend=c("Max stat","Q stat","Average stat"),col=c("red","blue","orange"),lty=1:1,lwd=2)



plot(mA-5,po,type="l",lty=1,ylab="Power",main="Power Curves",lwd=2,xlab="")
lines(mA-5,po2,lty=2,lwd=2)
lines(mA-5,po3,lty=15,lwd=2)
