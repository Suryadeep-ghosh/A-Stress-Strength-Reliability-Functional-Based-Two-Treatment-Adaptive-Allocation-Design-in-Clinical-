...
{
  set.seed(100)
  po[i]=power1.cauchy(100,5,5,sA[i],2,cr.val)
}
po_val=c(0.0502,0.4700,0.8616,0.9716)
#Average_stat
...
{
  set.seed(100)
  po2[i]=power2.cauchy(100,5,5,sA[i],2,cr.val2)
}
po2_val=c(0.0492,0.3598,0.6974,0.8602)
#Q_Stat
...
{
  set.seed(100)
  po3[i]=power3.cauchy(100,5,5,sA[i],2,cr.val3)
}
po3_val=c(0.0406,0.1820,0.3230,0.4294)

plot(sA-2,po_val,type="l",lty=1,main="Power Curve",xlab="Difference in sigma",ylab="Power",lwd=2)
