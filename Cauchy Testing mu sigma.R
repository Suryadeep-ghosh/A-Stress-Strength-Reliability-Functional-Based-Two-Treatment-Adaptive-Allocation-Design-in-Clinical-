...
{
  set.seed(100)
  po[i]=power1.cauchy(100,mA[i],5,sA[i],2,cr.val)
}
po_val=c(0.0502,0.6894,0.9774,0.9990)  #Updated
#Average_stat
...
{
  set.seed(100)
  po2[i]=power2.cauchy(100,mA[i],5,sA[i],2,cr.val2)
}
po2_val=c(0.0492,0.7404,0.9828,0.9992) #updated
#Q_Stat
...
{
  set.seed(100)
  po3[i]=power3.cauchy(100,mA[i],5,sA[i],2,cr.val3)
}
po3_val=c(0.0406,0.4550,0.7768,0.8908) #updated

plot(sA-2,po_val,type="l",lty=1,main="Power Curve",xlab="",ylab="Power",lwd=2)
lines(sA-2,po2_val,lty=2,lwd=2)
lines(sA-2,po3_val,lty=15,lwd=2)
