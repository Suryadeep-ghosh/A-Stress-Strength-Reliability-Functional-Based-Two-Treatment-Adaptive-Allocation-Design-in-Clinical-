...
cr.val1=5.258819
po1=c(0.0396,0.0626,0.0960)
po11=power.cov.norm1(3,2,4,3,s_A=4,s_B=4,critic.val=cr.val1)
po12=power.cov.norm1(4,2,5,3,s_A=4,s_B=4,critic.val=cr.val1)
po13=power.cov.norm1(5,2,6,3,s_A=4,s_B=4,critic.val=cr.val1)
plot(c(0,1,2,3),c(0.0396,p11,p12,p13),type="l",lty=1,xlab="Diferences of mu",ylab="Power",main="Power Curve",lwd=2)
p00=0.0396
p11=0.7706
p12=0.9986
p13=1
...
po21=power.cov.norm2(3,2,4,3,s_A=4,s_B=4,critic.val=cr.val2)
po22=power.cov.norm2(4,2,5,3,s_A=4,s_B=4,critic.val=cr.val2)
po23=power.cov.norm2(5,2,6,3,s_A=4,s_B=4,critic.val=cr.val2)
cr.val2=1.553204
p20=0.08
p21=0.8552
p22=0.9956
p23=1
lines(c(0,1,2,3),c(p20,p21,p22,p23),lty=2,lwd=2)
