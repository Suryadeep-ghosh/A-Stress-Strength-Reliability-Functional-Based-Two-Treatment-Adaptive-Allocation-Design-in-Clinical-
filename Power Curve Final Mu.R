...
plot(mA-5,po,type="l",col="red",xlab="difference in mu",ylab="Power",main="Power Curves",lwd=2)
...
{
  set.seed(100)
  po2[i]=power4.norm(100,mA[i],5,2,2,cr.val.Q)
}
...
{
  set.seed(100)
  po3[i]=power3.norm(100,mA[i],5,2,2,cr.val.A)
}
...
plot(mA-5,po,type="l",lty=1,xlab="difference in mu",ylab="Power",main="Power Curves",lwd=2)
