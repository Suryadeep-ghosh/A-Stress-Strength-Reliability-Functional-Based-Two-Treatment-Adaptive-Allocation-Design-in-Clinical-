...
po11=power.cov.norm1(3,2,4,3,s_A=6,s_B=4,critic.val=cr.val1)
po12=power.cov.norm1(4,2,5,3,s_A=8,s_B=4,critic.val=cr.val1)
po13=power.cov.norm1(5,2,6,3,s_A=10,s_B=4,critic.val=cr.val1)
p10=0.0396
p11=0.818
p12=1
p13=1
...
po21=power.cov.norm2(3,2,4,3,s_A=6,s_B=4,critic.val=cr.val2)
po22=power.cov.norm2(4,2,5,3,s_A=8,s_B=4,critic.val=cr.val2)
po23=power.cov.norm2(5,2,6,3,s_A=10,s_B=4,critic.val=cr.val2)
p20=0.08
p21=0.9434
p22=1
p23=1
plot(c(1,2,3,4),c(p10,p11,p12,p13),type="l",lty=1,main="Power Curve",xlab="",ylab="Power",lwd=2)
lines(c(1,2,3,4),c(p20,p21,p22,p23),lty=2,lwd=2)
